    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      <div class="flex flex-col gap-8">
        <div>
          ...
          <h2 class="mt-4 text-3xl font-bold text-gray-900 dark:text-white">Crear Nuevo Servicio</h2>
        </div>
        <form class="bg-white dark:bg-background-dark/50 shadow-lg rounded-xl overflow-hidden">
          <div class="p-6 sm:p-8 space-y-8">
            <div class="flex items-start gap-6">
              <div class="shrink-0">
                <div class="relative group">
                  <div class="h-24 w-24 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-500">
              ...
              <div class="flex-grow space-y-6">
                <div>
                  ...
                  <input class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary focus:ring-primary dark:bg-gray-700 dark:text-white sm:text-sm" id="service-name" name="service-name" required type="text" />
                </div>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div class="sm:col-span-2">
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                  ...
                  <input class="block w-full rounded-md border-gray-300 dark:border-gray-600 pl-7 pr-12 focus:border-primary focus:ring-primary dark:bg-gray-700 dark:text-white sm:text-sm" id="base-price" min="0" name="base-price" placeholder="0.00" required step="0.01" type="number" />
                </div>
              </div>
              <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                  <input class="block w-full rounded-md border-gray-300 dark:border-gray-600 pl-3 pr-20 focus:border-primary focus:ring-primary dark:bg-gray-700 dark:text-white sm:text-sm" id="base-duration" min="1" name="base-duration" placeholder="0" required type="number" />
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
              ...
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Selecciona en qué sucursales estará disponible este servicio.</p>
          ...
          <div class="bg-gray-50 dark:bg-gray-800/50 px-6 py-4 sm:px-8 flex justify-end gap-4">
            <button class="rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark" type="button" (click)="goBack($event)">Cancelar</button>
            <button class="inline-flex justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark" type="submit">Guardar</button>
          </div>
        </form>
      </div>
    </div>
